      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-[#111111] p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 fade-in transition-colors duration-200">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 w-full px-4 py-2.5 bg-white dark:bg-[#1a1a1a] border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder-gray-400 dark:placeholder-gray-500"
                placeholder="John Doe"
                data-testid="register-fullname-input"
              />
            </div>
            {errors.full_name && <p className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.full_name}</p>}
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-lg shadow-blue-500/20 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-6"

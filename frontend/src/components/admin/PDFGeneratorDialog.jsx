...
const PDFGeneratorDialog = ({ categories, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-2 sm:p-4 z-50 overflow-y-auto">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full my-2 sm:my-8 max-h-[95vh] sm:max-h-[90vh] overflow-y-auto" data-testid="pdf-generator-dialog">
        {/* Header */}
        <div className="border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between sticky top-0 bg-white z-10">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900">Generate Question Paper</h2>
          <button
            onClick={onClose}
